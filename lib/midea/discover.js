...
const V1_DEVICE_INFO_TIMEOUT_MS = 8000;
/**
...
function parseV2OrV3(msg, sourceAddress, protocol) {
    ...
    const appliance = {
        ...
        // midea-local discover.py:198 extracts model from bytes [17..25]
        // of the decrypted SN block — useful for adapters that present a
        // catalogue entry. Other discovery paths derive model from a
        // lengths-based slice of apc_sn; this V2/V3 path always has the
        // 8-char window available.
        model: trimNul(data.subarray(17, 25).toString()),
        ssid,
        macAddress,
        applianceType,
