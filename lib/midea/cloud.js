...
// SmartHomeCloud iotKey from midea-local — base64(appKey:iotKey) goes into the
// Authorization header on every V3 request.
...
class CloudClient {
    constructor(opts) {
        ...
        this._authBase = Buffer.from(`${this.appKey}:${this._iotKey}`).toString("base64");
    ...
    async _apiRequest(path, payload) {
        ...
        const headers = {
            ...
            "x-recipe-app": this.appId || "1010",
            authorization: `Basic ${this._authBase}`,
        };
