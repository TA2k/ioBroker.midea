...
class HumidifierDevice extends BaseDevice {
    ...
    _processFrame(frame, _ctx) {
        ...
        return this._mergeStatus(this._normalize(parseFDResponse(inner)));
    }
    ...
    async setStatus(updates = {}) {
        ...
        if (updates.fanSpeed !== undefined) {
            ...
            const reverse = Object.fromEntries(Object.entries(map).flatMap(([raw, name]) => [[name, Number(raw)], [name.toLowerCase(), Number(raw)]]));
