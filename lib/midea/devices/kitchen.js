...
class OvenDevice extends _ReadOnlyKitchen {
    ...
    _processFrame(frame, _ctx) {
        ...
        return this._mergeStatus(parseB1(inner));
    }
}
...
class SteamerDevice extends _ReadOnlyKitchen {
    ...
    _processFrame(frame, _ctx) {
        if (!frame || frame.length < 12) return undefined;
        const inner = frame.subarray(10, frame.length - 1);
        return this._mergeStatus(parseB3Reply(inner));
    }
}
...
class OvenSteamDevice extends _ReadOnlyKitchen {
    ...
    _processFrame(frame, _ctx) {
        if (!frame || frame.length < 12) return undefined;
        const inner = frame.subarray(10, frame.length - 1);
        return this._mergeStatus(parseB4(inner));
    }
}
...
class IntegratedOvenDevice extends BaseDevice {
    ...
    _processFrame(frame, _ctx) {
        if (!frame || frame.length < 12) return undefined;
        const inner = frame.subarray(10, frame.length - 1);
        return this._mergeStatus(parseKitchenStandard(inner));
    }
