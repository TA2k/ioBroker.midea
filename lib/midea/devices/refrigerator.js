...
// midea-local 6.5.0 (commit 1a87ee6) added human-readable strings for
// the variable_mode and humidity fields.
const VARIABLE_MODE_NAMES = {
    0x00: "none",
    0x01: "soft_freezing",
    0x02: "zero_fresh",
    0x03: "cold_drink",
...
const HUMIDITY_NAMES = { 0x10: "high", 0x20: "low" };
...
function parseCAGeneral(body) {
    ...
    out.variableModeName = VARIABLE_MODE_NAMES[body[5]] || null;
    ...
    if (body.length > 25) {
        ...
        out.humidityName = HUMIDITY_NAMES[body[27] & 0x70] || null;
