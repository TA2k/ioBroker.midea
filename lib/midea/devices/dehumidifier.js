...
const a1maps = require("../generated/a1-maps");

const APPLIANCE_TYPE_DEHUMIDIFIER = 0xA1;

// Mode-byte → name mappings come from generated/a1-maps.js, sourced from
// the cloud-served Lua plugin (T_0000_A1_*.lua: VALUE_MODE_*). Re-run
// `npm run sync-maps` after updating the Lua cache.
//   0=invalid, 1=set, 2=continuity, 3=auto, 4=dry_clothes, 5=dry_shoes, 8=fan
// We expose the live entries (drop the 0=invalid sentinel — it's a "no
// mode set" marker and is never reported by the device).
