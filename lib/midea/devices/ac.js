    ...
    _processFrame(frame, ctx) {
        ...
        if (parsed.type === 0xC1) {
            const fields = [
                ...
                // Alternate codec decodings of the same energy bytes —
                // exposed as separate states so the user can pick the
                // variant that matches the SmartHome app reading.
                "totalEnergyConsumptionBinary", "totalEnergyConsumptionMsmartBCD",
                "currentEnergyConsumptionBinary", "currentEnergyConsumptionMsmartBCD",
                "realtimePowerBinary", "realtimePowerMsmartBCD",
                "electrifyTime", "totalOperatingTime", "currentOperatingTime",
                "electrifyTimeHours", "totalOperatingTimeHours", "currentOperatingTimeHours",
                "indoorHumidity",
            ];
            const m = {};
