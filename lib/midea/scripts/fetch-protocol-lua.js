...
//
// Tried but rejected by the cloud with code=1318 ("no plugin available").
// Kept here so we don't waste another GitHub-search round on the same
// (type, sn) pairs — replace the SN if a richer one shows up:
//   0x1A smart_toilet            00001A311MSGWB0010C0411020279BWP
//   0x3D water_dispenser         00003D31163400130190321035063KPJ
//   0xB0 microwave               0000B0511700006BA4530140021120S3
//   0xB3 steamer                 0000B35117310032C342921000975MCQ
//   0xBF integrated_oven         0000BF511700006AG41151400349ASW4
//   0xCC commercial_ac           0000CC341171PANEL6RT9HH32WA00000
//   0xCC commercial_ac           0000CC341171PNL0150L4HRSKLC20000
//   0xD9 sterilizer              0000D951138209227A2096503395Z346
//   0xDC dryer                   0000DC5113820633143205A021174N38
//   0xFB electric_heater         0000FB3115706671Q1A081103066L83W
//   0xFD humidifier              0000FD511202Z3119A2183100462LJQF
const DEFAULT_SN_CATALOG = [
    { type: 0x1A, sn: "00001A311MSGWB0010C0411020279BWP" }, // smart toilet -- code=1318 last try
    { type: 0x3D, sn: "00003D31163400130190321035063KPJ" }, // water dispenser -- code=1318
    ...
    { type: 0xB0, sn: "0000B0511700006BA4530140021120S3" }, // microwave -- code=1318
    { type: 0xB3, sn: "0000B35117310032C342921000975MCQ" }, // steamer -- code=1318
    { type: 0xBF, sn: "0000BF511700006AG41151400349ASW4" }, // integrated oven -- code=1318
    ...
    { type: 0xCC, sn: "0000CC341171PANEL6RT9HH32WA00000" }, // commercial ac -- code=1318
    { type: 0xCC, sn: "0000CC341171PNL0150L4HRSKLC20000" }, // commercial ac (alt) -- code=1318
    { type: 0xCD, sn: "0000CD311RSJRAC074715B100019Y57G" }, // heat-pump water heater
    { type: 0xD9, sn: "0000D951138209227A2096503395Z346" }, // sterilizer -- code=1318
    { type: 0xDB, sn: "0000DB51138124205A2155A00298VTX0" }, // washer (front-load)
    { type: 0xDB, sn: "0000DB5133812912037035A00186J2WH" }, // washer (front-load, alt)
    { type: 0xDC, sn: "0000DC5113820633143205A021174N38" }, // dryer -- code=1318
    ...
    { type: 0xFA, sn: "0000FA511560000F345291100215UUQ6" }, // fan
    { type: 0xFB, sn: "0000FB3115706671Q1A081103066L83W" }, // electric heater -- code=1318
    { type: 0xFD, sn: "0000FD511202Z3119A2183100462LJQF" }, // humidifier -- code=1318
];

// Appliance types from discover.js APPLIANCE_TYPES that we have NEVER
// found a working SN for. Either no GitHub-public SN exists, or every
// SN we tried was rejected by the cloud. Adding a new entry here is the
// next-best thing if you don't have access to a real account that
// owns one. Use `npm run fetch-lua -- --type 0xXX --sn FULLSERIAL` to
// probe a single (type, sn) pair without polluting the default run.
//   0x13 light
...
//   0xB1 oven
//   0xB4 oven_steam
//   0xC2 smart_toilet (different from 0x1A)
//   0xCE fresh_air
//   0xCF heatpump (different from 0xC3 controller)
